...
class PartEditScreen extends StatefulWidget {
  ...
  const PartEditScreen({Key? key, required this.documentSnapshot})
      : super(key: key);
  ...
  void initState() {
    ...
    descriptionController = TextEditingController(
        text: widget.documentSnapshot != null
            ...
            : '');
    imgUrl = widget.documentSnapshot['imageUrl'].toString();
  }
                                    ...
                                    onPressed: () async {
                                      if (_formKey.currentState!.validate() &&
                                        ...
                                        Part part = Part(
                                            ...
                                            partId: widget
                                                .documentSnapshot['partId']);
                                        await FirestorePartService()
                                            .updatePart(part);
